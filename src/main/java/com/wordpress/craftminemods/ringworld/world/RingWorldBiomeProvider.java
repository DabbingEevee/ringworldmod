...
public class RingWorldBiomeProvider extends BiomeProvider {
	private GenLayer genBiomes;
	private GenLayer biomeIndexLayer;
	private BiomeCache biomeCache;
	public RingWorldBiomeProvider() {
		this.biomeCache = new BiomeCache(this);
	}

	public RingWorldBiomeProvider(long seed) {
		this.biomeCache = new BiomeCache(this);
	...
	public RingWorldBiomeProvider(World world) {
		this(world.getSeed());
	}
