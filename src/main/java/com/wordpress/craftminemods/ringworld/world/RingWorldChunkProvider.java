...
public class RingWorldChunkProvider implements IChunkGenerator {
	private static final IBlockState STONE = Blocks.GRASS.getDefaultState();
	private static final IBlockState STONE2 = Blocks.EMERALD_ORE.getDefaultState();
	private static final IBlockState FLUID = Blocks.SPONGE.getStateFromMeta(1);
	private static final IBlockState AIR = Blocks.AIR.getDefaultState();
	private static final IBlockState BEDROCK = Blocks.COAL_BLOCK.getDefaultState();
	...
	public RingWorldChunkProvider(World worldIn, long seed) {
